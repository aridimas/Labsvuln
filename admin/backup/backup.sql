...
('ilham',	1,	'Test Barang 1',	'barang ini keramat hati hati',	123);
...
('Hiasan Dinding Kontemporer : Infinite, mengandung keunikan tersendiri dalam karyanya yang membuat karya ini menarik dimata penikmatnya ',	200,	1,	'Hiasan Dinding Kontemporer csrf',	12,	'Reynold Jeremy'),
...
('Hiasan Dinding Ruang Tamu : japanese art, mengandung keunikan tersendiri dalam karyanya yang membuat karya ini menarik dimata penikmatnya . lukisan ini biasa di tempelkan di ruang tamu rumah',	100,	3,	'Hiasan Dinding Ruang Tamu : japanese art',	20,	'Keilan'),
('Hiasan Dinding : Abstractika Gold , Nikmati seni terbaik dunia yang akan menghidupkan kehidupan di ruangan atau pengaturan mana pun. Pilih dari pilihan bingkai berkualitas tinggi kami yang indah untuk dipadukan dengan karya seni yang tepat yang cocok untuk Anda. Semua cetakan tiba siap untuk digantung.',	250,	4,	'Hiasan Dinding : Abstractika Gold',	8,	'hanif'),
('Hiasan Dinding Ruang Tamu : Planto Negra, Nikmati seni terbaik dunia yang akan menghidupkan kehidupan di ruangan atau pengaturan mana pun. Pilih dari pilihan bingkai berkualitas tinggi kami yang indah untuk dipadukan dengan karya seni yang tepat yang cocok untuk Anda. Semua cetakan tiba siap untuk digantung.',	150,	5,	'Hiasan Dinding Planto Negra',	17,	'Deo sidabutar'),
...
('Ombre Dream Cubes, Nikmati seni terbaik dunia yang akan menghidupkan kehidupan di ruangan atau pengaturan mana pun. Pilih dari pilihan bingkai berkualitas tinggi kami yang indah untuk dipadukan dengan karya seni yang tepat yang cocok untuk Anda. Semua cetakan tiba siap untuk digantung.',	512,	9,	'Ombre Dream Cubes',	1,	'ismail prabowo'),
...
('Hiasan Dinding : Perforation, Nikmati seni terbaik dunia yang akan menghidupkan kehidupan di ruangan atau pengaturan mana pun. Pilih dari pilihan bingkai berkualitas tinggi kami yang indah untuk dipadukan dengan karya seni yang tepat yang cocok untuk Anda. Semua cetakan tiba siap untuk digantung.',	450,	11,	'Perforation',	5,	'Tiesna'),
('Hiasan Dinding : Ventura, Nikmati seni terbaik dunia yang akan menghidupkan kehidupan di ruangan atau pengaturan mana pun. Pilih dari pilihan bingkai berkualitas tinggi kami yang indah untuk dipadukan dengan karya seni yang tepat yang cocok untuk Anda. Semua cetakan tiba siap untuk digantung.',	312,	12,	'Ventura',	3,	'Robert');
